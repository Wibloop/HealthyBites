...
class App:
    ...
    def verificar(self):
        #Esto sirve para verificar si el usuario y la contraseña son correctos
        ...
        if self.usuario.get() == 'admin' and self.contraseña.get() == 'admin':
            ...
            #Esto sirve para mostrar un mensaje de error
    ...
    def __init__(self):
        ...
        boton_iniciar_sesion = tk.Button(frame_formulario_bottom, text='Iniciar Sesión', bg='#567159', fg="#fff0d3", font=('Forte', 20), command=self.verificar)
